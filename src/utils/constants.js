//API Base URL
export const API_URL = 'http://api.firstrespondersyogacanada.com/api';
...
export const config = {
    ...
    aboutus_url: "http://api.firstrespondersyogacanada.com/api/cms-page/1",
    contactus_url: "http://api.firstrespondersyogacanada.com/api/cms-page/2"
}
